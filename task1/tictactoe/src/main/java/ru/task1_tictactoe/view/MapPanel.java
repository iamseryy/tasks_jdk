...
public class MapPanel extends JPanel {
    ...
    private static final String MSG_DRAW = "Game draw !";
    private static final String GAME_OVER = "Game over";
    private int cellWidth;
    private int cellHeight;
    private boolean isInitialized;
    private boolean isGameOver;
    private boolean isNeedNewGame;
    ...
    public void start(int mode, int sizeX, int sizeY, int winLength ){
        fieldSizeY = sizeX;
        fieldSizeX = sizeY;
    ...
    private void showMessageGameOver(Graphics g) {
        var mess = "";
        switch (gameOverType) {
            case STATE_DRAW: mess = MSG_DRAW;
                break;
            case STATE_WIN_AI: mess = MSG_WIN_AI;
                break;
            case STATE_WIN_HUMAN: mess = MSG_WIN_HUMAN;
                break;
            default:
...
//        repaint();
//        try {
//            Thread.sleep(500); // <-- This is an INCREDIBLY bad idea, NEVER, EVER do this
//
